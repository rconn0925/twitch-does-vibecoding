...
Last activity: 2026-07-11 -- Completed quick task 260711-ur2: command layer C (on-screen /commands reference page + candidate kind chips + phase-banner truncation fix + FREE REIGN usage hint)
